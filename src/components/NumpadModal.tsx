...
import { View, Text, TouchableOpacity, Modal, Animated, Image, TextInput, TouchableWithoutFeedback, KeyboardAvoidingView, Platform } from 'react-native';
...
export const NumpadModal = ({ visible, title, hint, confirmLabel, amount, currency, onChangeAmount, onConfirm, onClose, withNote = false }: {
  ...
  const goToNote = () => {
    haptic.success();
    setStep('note');
    Animated.spring(noteAnim, { toValue: 1, useNativeDriver: true, tension: 120, friction: 9 }).start();
          ...
          <KeyboardAvoidingView
            ...
            keyboardVerticalOffset={24}>
              <TouchableWithoutFeedback onPress={() => {}}>
                <Animated.View style={{ transform: [{ scale: scaleAnim }], width: '86%', alignSelf: 'center', backgroundColor: '#3B2220', borderRadius: 28, padding: 22, paddingBottom: 18, borderWidth: 1.5, borderColor: 'rgba(212,149,106,0.35)', shadowColor: '#000', shadowOffset: { width: 0, height: 14 }, shadowOpacity: 0.55, shadowRadius: 28, elevation: 24 }}>
